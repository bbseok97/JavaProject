...
public class G02_consumerEx {
	...
	/*
	 * 	자바의 표준 API에서 한 개의 추상 메서드를 가진 인터페이스들은 모두 람다식으로 사용할 수 있어요.
	 * 	람다에 사용되는 함수적 인터페이스를 java.util.function package에 설정해서 
	 * 	사용하고 있습니다.
	 * 	인터페이스 종류는 크게 5가지
	 * 	- Consumer	: 매개변수가 있고, 리턴값이 없는 경우에 사용
	...
	// 인터페이스
	// Consumer<T>	- 추상 메서드 void accept(T t)		T는 매개변수
	// BiConsumer<T, U>	- 추상 메서드 void accept(T t, U u)
	//	xxxConsumer	- 각 데이터 타입에 따른 Consumer(IntConsumer, LongConsumer, DoubleConsumer)		//받는 타입을 표기
