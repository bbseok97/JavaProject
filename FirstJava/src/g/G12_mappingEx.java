...
public class G12_mappingEx {
	...
	/*
	 * 	매핑(Mapping)  : 컬렉션 프레임워크에 Map에 key와 value와 같이 묶어주는 것과 같은
	 * 					형태로 만들어주는 개념.	매핑은 Stream의 데이터를 매개변수로 받아서 가공처리 후
	...
	public static void main(String[] args) {
		...
		list1.stream().flatMap(data -> Arrays.stream(data.split(" ")))		//" "으로 분리
		...
		// mappXXX() 메서드	: 요소를 새로 구성해서 새로운 스트림을 리턴
