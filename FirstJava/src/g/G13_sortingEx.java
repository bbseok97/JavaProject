...
public class G13_sortingEx {
	...
	/*
	 * 	Stream의 중간 단계에서 sorted 메서드를 사용하여 순서를 변경할 수 있다.
	 * 	일반적인 객체를 정렬하기 위해서는 Comparable 인터페이스를 구현한 클래스 객체만 
	 * 	정렬 가능함.
	 *	 
	 */
	public static void main(String[] args) {
		...
		System.out.println("람다표현식을 이용해서 둘레순으로 정렬");			//추상 메서드가 1개일때 람다식 사용 가능
