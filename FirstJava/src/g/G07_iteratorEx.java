...
public class G07_iteratorEx {
	...
	/*
	 * 	스트림 : 	여러 값들을 가지고 있는 배열이나 컬렉션 등을 for문이 아닌 함수형 인터페이스를
	 ...
	 * 
	 * 	외부 반복자	vs	내부 반복자
	 * 	외부 반복자	: 컬렉션 내에서 요소를 반복문을 통해 하나씩 읽어 처리하는 방식
	...
	public static void main(String[] args) {
		...
		list.stream().forEach(s -> System.out.println(s));	//stream을 통해 forEach를 이용하여 내부 반복
	}
