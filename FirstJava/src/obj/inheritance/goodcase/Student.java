...
public class Student extends Person{
	...
	public Student(String name, int age) {	//자식 생성자
		super();	// 부모 생성자의 인자값을 참조하여 처리
	}
	
	public Student(String name, int age, String studentId, String major) {
		this(name, age);		//상속값을 불러오고
		height = 179.6f;		// 부모의 멤버 중 protected 멤버 변수...
//		weight = 100.0f;		// default로 참조가 되지 않아요...
	...
	//	재정의 규칙
	// - 상속을 전재로 함
	// - 리턴 타입, 메서드 이름, 파라미터 변수 선언이 모두 일치해야 함...
	// - 접근 제한자는 같거나 more public 해야 함...
	// 	private < default < protected < public
	
	
	@Override	// 상속받은 내용을 쓰고싶은 방법으로 변경할 때 사용
