...
public class D15_stringEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.substring(0, 5));	//0번 인덱스 부터 5번 인덱스 미만까지 (5번 포함X)
		...
		// 3. indexOf : 원하는 문자의 인덱스를 반환 (못찾는 경우 -1로 표기됨)
		int orangeIndex = str.indexOf("orange");
		System.out.println("오렌지 위치 : " + orangeIndex);
		System.out.println("첫 번째 o의 위치 : " +str.indexOf('o'));
		System.out.println("두 번째 o의 위치 : " +str.indexOf('o', str.indexOf('o')+1));
		System.out.println("첫 번쨰 x의 위치 : " +str.indexOf('x'));
		...
		String orange = str.substring(
									str.indexOf("orange"),
									str.indexOf("orange")+"orange".length());	//문자열은 메서드
