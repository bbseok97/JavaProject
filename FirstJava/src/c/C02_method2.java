...
public class C02_method2 {
	...
	public static void main(String[] args) {
		 ...
		 *    그리고, 매개 변수가 없다면 반환 유형 처리 void는 사용하지 않고, 소괄호로 안을 비워 둡니다. 
		 *    
		 *  ** 반환 유형(return type)
	...
	// 유형1
	static int add (int num1, int num2) {	//전달 인자도 있고, 반환값도 있을경우
		int result = num1 + num2;
		return result;
	}
	
	// 유형2
	static void showResult(int result) {	//전달 인자는 있고, 반환값은 없는경우
		System.out.println("덧셈 결과 : "+result);
	}
	
	// 유형3
	static int input() {	//전달 인자는 없고, 반환값은 있는 경우
	...
	// 유형4
	static void print() {	// 전달인자도 없고 반환값도 없는경우
